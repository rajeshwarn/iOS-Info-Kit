...
namespace MK.MobileDevice
{
    public class iPhone
    {
        ...
        */
        ...
        {
            throw new NotImplementedException("Copiado no esta im.");
        }
        ...
        {
            //No implementado todavia xDxDxD
        }
        ...
        public void SetCurrentDirectory(string path)
        {
            ...
            if (!this.IsDirectory(str))
            {
                throw new Exception("Directorio especificado no es correcto!!");
            }
        ...
        public void MountDeveloperDisk()
        {
            throw new NotImplementedException();
        }
    }
